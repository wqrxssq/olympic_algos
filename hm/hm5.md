...
2) $x_0 > \sqrt[4]{a}$, тогда $x_0 > \frac{a}{{x_0}^3}$ $$\varphi(x_0) = \frac{1}{4}(3x_0 + \frac{a}{x^3}) < \frac{1}{4}(3x_0 + x_0) < x_0$$ $$\varphi(x_0) = \frac{1}{4}(3x_0 + \frac{a}{x^3}) \geq \frac{1}{4}(3\frac{a}{x^3} + \frac{a}{x^3}) = \frac{a}{x^3}$$ То последовательность справа монотонно убывает к $\sqrt[4]{a}$.

3) $x_0 < \sqrt[4]{a}$, тогда $\varphi(x_0) = \frac{1}{4}(3x_0 + \frac{a}{x^3}) > \frac{1}{4}(3x_0 + x_0) > x_0$. То есть последовательность слева монотонно 
